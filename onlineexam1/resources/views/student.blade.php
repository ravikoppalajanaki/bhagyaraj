...
@section('content')
		...
		@if(session()->has('errors'))
		  ...
		  <div class="box box-info">
		    ...
		    <div class="box-body">
		  <!-- form start -->
                <form action="{{url('student/add')}}" method="post"  enctype="multipart/form-data" class="form-horizontal">
					{!! csrf_field() !!}
		  ...
		  <div class="box box-info">
		    ...
		    <div class="box-body">
		  <!-- form start -->
                <form action="{{url('student/update')}}" enctype="multipart/form-data"  method="post" class="form-horizontal">
					{!! csrf_field() !!}
                  <div class="box-body" id="addformdiv">
          ...
          <div class="box box-default">
            <div class="box-header with-border">
			  ...
			  <a class="btn btn-primary btn-small" onclick="addstudent();">Add Student</a>
			  </div>
            </div><!-- /.box-header -->
            <div class="box-body">
				...
				<td style="text-align:center"><b>Action</b></td></tr>
				 @foreach ($Student as $S)
					...
					<a class="btn btn-primary btn-small" title="Edit" onclick="editstudent({{$S->id}}, {{$S->RollNo}}, '{{$S->Name}}')"><i class="fa fa-edit" aria-hidden="true"></i></a>
					<a class="btn btn-primary btn-small" title="Delete" onclick="deletestudent({{$S->id}});"><i class="fa fa-trash" aria-hidden="true"></i></a>
					</td></tr>
				@endforeach
				</table>
            </div><!-- /.box-body -->
...
@section('extra')
  <script>
	...
	function deletestudent(a)
	{
		...
		if(c)
		{
		window.location = "{{url('student/remove/')}}/"+a;
		}
	}
</script>
@endsection