...
<body class="builderUI">
    ...
    <div id="builder">
        ...
        <div class="container">
            ...
            <header class="clearfix affix"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
              ...
              <!--  <a href="#exportModal" id="exportPage" data-toggle="modal" class="btn btn-inverse pull-right actionButtons slick" style="display: none">
                ...
                -->
                <a href="#" id="publishPage" class="btn btn-inverse pull-right actionButtons slick" data-siteid="<?php echo $siteData['site']->sites_id;?>" <?php if( $siteData['site']->ftp_ok == 1 ):?>data-toggle="tooltip" data-placement="bottom" title="You can not publish your site right now. Please update your FTP details."<?php endif;?> style="display: none">
                    <i class="fui-upload"></i> 
                    <span class="slide"><?php echo $this->lang->line('actionbuttons_publish')?></span>
                    <i class="fui-alert text-danger" <?php if( $siteData['site']->ftp_ok == 0 ):?>style="display:none"<?php endif;?>>
                    </i>
                </a>
