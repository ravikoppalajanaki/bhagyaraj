...
<body>
    				...
    				<div class="site" data-name="<?php echo $site['siteData']->first_name;?> <?php echo $site['siteData']->last_name;?>" data-pages="<?php echo $site['nrOfPages'];?>" data-created="<?php echo date("Y-m-d", $site['siteData']->sites_created_on);?>" data-update="<?php if( $site['siteData']->sites_lastupdate_on != '' ){echo date("Y-m-d", $site['siteData']->sites_lastupdate_on);}?>" id="site_<?php echo $site['siteData']->sites_id;?>">
    					...
    					<div class="siteDetails">
    						...
    						<div class="clearfix">
    							...
    							<a href="<?php echo site_url('sites/'.$site['siteData']->sites_id)?>" class="btn btn-primary btn-embossed btn-block btnSite"><span class="fui-new"><span style="font-size: 16px;padding-left: 5px;font-family: 'Lato',Helvetica,Arial,sans-serif;"><?php echo $this->lang->line('sites_button_editthissite')?></span></span> </a>
    							
    							<a href="#" class="btn btn-info btn-embossed btn-block btn-full pull-left btn-sm siteSettingsModalButton first" data-siteid="<?php echo $site['siteData']->sites_id?>"><span class="fui-gear"></span> <?php echo $this->lang->line('sites_button_settings')?></a>
	...
	<?php $this->load->view("shared/1modal_sitesettings.php");?>
