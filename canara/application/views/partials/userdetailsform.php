		...
		<div class="form-group">
			<div class="col-md-6">
	        	<label class="checkbox" for="checkbox-admin-<?php echo $user['userData']->id;?>" style="padding-top: 0px;">
	       			<input type="checkbox" value="yes" <?php if( $user['is_admin'] == 'yes' ):?>checked<?php endif;?> name="isAdmin" data-toggle="checkbox" id="checkbox-admin-<?php echo $user['userData']->id;?>">
